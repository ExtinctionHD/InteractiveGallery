...
PhotoCardRenderPass::PhotoCardRenderPass(Device *device, SwapChain *swapChain, VkSampleCountFlagBits sampleCount)
    : RenderPass(device, swapChain->getExtent(), sampleCount),
      swapChain(swapChain)
{
}

uint32_t PhotoCardRenderPass::getColorAttachmentCount() const
{
    return 1;
}

std::vector<VkClearValue> PhotoCardRenderPass::getClearValues() const
{
...
void PhotoCardRenderPass::createAttachments()
{
}

void PhotoCardRenderPass::createRenderPass()
{
...
void PhotoCardRenderPass::createFramebuffers()
{
